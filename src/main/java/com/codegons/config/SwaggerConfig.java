...
public class SwaggerConfig {
	...
	private static final String DESCRIPTION = "to do application ";
	...
	private ApiInfo apiInfo() {
		...
		return new ApiInfoBuilder()
				.contact(new springfox.documentation.service.Contact("codegons",
						"https://github.com/codegons", "codegoeson@gmail.com"))
